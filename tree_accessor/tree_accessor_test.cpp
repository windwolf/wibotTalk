// #include "tree_accessor_test.hpp"
// #include "minunit.h"
// #include <stdlib.h>
...
//                                 void **out);
// static bool test_cfg_value_getter(const void *context, const int32_t index,
//                                   char *out);
// static bool test_cfg_value_setter(const void *context, const int32_t index,
//                                   char *in);
// static TreeAccessor ta;
// static TreeAccessorItemEntry aa = {.name = "aa"};
// static TreeAccessorItemEntry bbs = {.name = "bbs",
//                                     .rawGetter = test_cfg_raw_getter};
// static TreeAccessorItemEntry bf1 = {.name = "bf1",
...
// static TreeAccessorItemEntry aa_a1_f1 = {.name = "f1",
//                                          .getter = test_cfg_value_getter};
// static TreeAccessorItemEntry aa_a1_f2 = {.name = "f2",
//                                          .getter = test_cfg_value_getter};
...
//     MU_ASSERT(strcmp(_bbs->name, "bbs") == 0);
//     TreeAccessorItemEntry *_bf1 = (TreeAccessorItemEntry *)_bbs->base.child;
//     MU_ASSERT(strcmp(_bf1->name, "bf1") == 0);
//     TreeAccessorItemEntry *_aa_a1 = (TreeAccessorItemEntry *)_aa->base.child;
//     MU_ASSERT(strcmp(_aa_a1->name, "a1") == 0);
//     TreeAccessorItemEntry *_aa_a2 = (TreeAccessorItemEntry *)_aa_a1->base.next;
//     MU_ASSERT(strcmp(_aa_a2->name, "a2") == 0);
//     TreeAccessorItemEntry *_aa_a1_f1 =
//         (TreeAccessorItemEntry *)_aa_a1->base.child;
//     MU_ASSERT(strcmp(_aa_a1_f1->name, "f1") == 0);
//     TreeAccessorItemEntry *_aa_a1_f2 =
//         (TreeAccessorItemEntry *)_aa_a1_f1->base.next;
//     MU_ASSERT(strcmp(_aa_a1_f2->name, "f2") == 0);
// };
